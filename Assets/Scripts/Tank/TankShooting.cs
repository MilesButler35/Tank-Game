...
public class TankShooting : MonoBehaviour
{
    ...
    private void Update ()
    {
        ...
        if (m_CurrentLaunchForce >= m_MaxLaunchForce && !m_Fired && offCooldown)
        {
        ...
        else if (Input.GetButtonDown (m_FireButton) && offCooldown)
        {
        ...
        else if (Input.GetButton (m_FireButton) && !m_Fired && offCooldown)
        {
        ...
        else if (Input.GetButtonUp (m_FireButton) && !m_Fired && offCooldown)
        {
            // ... launch the shell.
            Fire ();
        }
